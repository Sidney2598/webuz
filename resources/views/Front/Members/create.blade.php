                      ...
                      <form action="{{route('members.store')}}" method="post">
                        ...
                        <div class="row mb-3">
                          <div class="col-sm-6">
                            ...
                            <input type="text" name="name" class="form-control" id="basic-default-name" placeholder="F.I.O" />
                          </div>
                          <div class="col-sm-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-4">
                              <label class=" col-form-label" for="basic-default-name">Ilmiy daraja</label>
                              <input type="text" name="ilmiy_daraja" class="form-control" id="basic-default-name" placeholder="t.f.f.d" />
                            </div>
                            <div class="col-sm-4">
                              <label class=" col-form-label" for="basic-default-name">Login</label>
                              <input type="text" name="login" class="form-control" id="basic-default-name" placeholder="Login" />
                            </div>
                            <div class="col-sm-4">
                              <label class=" col-form-label" for="basic-default-name">Parol</label>
                              <input type="password" name="password" class="form-control" id="basic-default-name" placeholder="Parol" />
                            </div>
                          </div>
