...
namespace App\Http\Controllers\Front\PermissionHas;
...
class Controller extends B
{
    ...
    public function index()
    {
        ...
        ->select('users.id as user_id','users.name as username','permissions.id as permission_id','permissions.name as rolename')
        ->get();
